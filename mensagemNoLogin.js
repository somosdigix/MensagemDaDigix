class MensagemNoLogin {
  constructor() {
    this.caminhoDaImagem = '';
    this.chave = 'sistemaFora';
    this.classDosElementos = 'mensagemDaDigix';
    this.mensagemDoSuporte = 'https://somosdigix.github.io/MensagemDaDigix/mensagem-login.png';
